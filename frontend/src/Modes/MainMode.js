...
import { altStyles, styles } from '../UI_Components/UIComponents';
...
const MainMode = (props) => {
  ...
  // const modeChange = throttle(
  //   (roomId, mode, adminName) => {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MainMode)
);
